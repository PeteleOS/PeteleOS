...
END {
	...
	getindex("/sys/man/2")
	getnmlist("/amd64/lib/lib9p.a")
	getnmlist("/amd64/lib/libauth.a")
	getnmlist("/amd64/lib/libauthsrv.a")
	getnmlist("/amd64/lib/libbin.a")
	getnmlist("/amd64/lib/libbio.a")
	getnmlist("/amd64/lib/libc.a")
	getnmlist("/amd64/lib/libcontrol.a")
	getnmlist("/amd64/lib/libdisk.a")
	getnmlist("/amd64/lib/libdraw.a")
	getnmlist("/amd64/lib/libflate.a")
	getnmlist("/amd64/lib/libframe.a")
	getnmlist("/amd64/lib/libgeometry.a")
	getnmlist("/amd64/lib/libhtml.a")
	getnmlist("/amd64/lib/libhttpd.a")
	getnmlist("/amd64/lib/libip.a")
	getnmlist("/amd64/lib/libmach.a")
	getnmlist("/amd64/lib/libmemdraw.a")
	getnmlist("/amd64/lib/libmemlayer.a")
	getnmlist("/amd64/lib/libmp.a")
	getnmlist("/amd64/lib/libndb.a")
	getnmlist("/amd64/lib/libplumb.a")
	getnmlist("/amd64/lib/libregexp.a")
	getnmlist("/amd64/lib/libsec.a")
	getnmlist("/amd64/lib/libstdio.a")
	getnmlist("/amd64/lib/libString.a")
	getnmlist("/amd64/lib/libthread.a")
	for (i in List) {
