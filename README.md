...
1. Original Plan 9 and 9legacy code
   Copyright 2021 Plan 9 Foundation
   Licensed under the MIT License.
   See LICENSE_PLAN9FOUNDATION.

2. New code contributed by PeteleOS
   Licensed under the Blue Oak Model License 1.0.0.
   See LICENSE.md.

Unless otherwise stated in a source file or directory, new
original code in this project is licensed under the Blue Oak
Model License 1.0.0.
